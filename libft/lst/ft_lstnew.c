...
/*
  ...
  sizeof(t_stack)
    - The sizeof(t_stack) is related to the size of the structure itself,
    ...
    - If you store an int in the content member,
		...
		The sizeof(t_stack) remains the same because the size of a pointer
    ...
    - If you store a char * in the content member, 
		...
		Again, the sizeof(t_stack) remains the same.
*/
